...
import rs.levi9.tech9.team3.domain.Role.RoleType;
...
public class NotificationService {
	...
	public void sendReportToAdmin(User logedInUser, Long commentId, String reportReason) {
		List<User> listOfUsers = userRepository.findAll();
		for (User user : listOfUsers) {
			List<Role> listOfRolesForUser = (List<Role>) user.getRoles();
