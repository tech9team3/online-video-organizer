(function () {
    ...
    LoginRegisterController.$inject = ['$location', '$http', '$route', 'UserService', 'vcRecaptchaService', '$scope'];

    function LoginRegisterController($location, $http, $route, UserService, vcRecaptchaService, $scope) {
